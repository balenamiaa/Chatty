...
public sealed class VoiceService : IVoiceService
{
  ...
  public Task<Result<bool>> EnableVideoAsync(Guid callId, Guid userId, bool enabled, CancellationToken ct = default)
  {
    throw new NotImplementedException();
  }

  public Task<Result<IReadOnlyList<CallParticipantDto>>> GetParticipantsAsync(Guid callId, CancellationToken ct = default)
  {
    throw new NotImplementedException();
  }
